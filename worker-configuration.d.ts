/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: 6877294b13a76fdf613d6f9a50fe360b)
...
interface __BaseEnv_Env {
	...
	DB: D1Database;
	BETTER_AUTH_URL: "https://blackvector.win";
	BETTER_AUTH_TRUSTED_ORIGINS: "https://blackvector.win,https://www.blackvector.win,https://black-vector-website.curtisl-conrad.workers.dev";
	AUTH_EMAIL_FROM: "Black Vector <access@blackvector.win>";
	SUPPORT_CHECKOUT_ENABLED: "false";
	CHAT_ROOMS: DurableObjectNamespace<import("./dist/server/index").ChatRoom>;
}
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "BETTER_AUTH_URL" | "BETTER_AUTH_TRUSTED_ORIGINS" | "AUTH_EMAIL_FROM" | "SUPPORT_CHECKOUT_ENABLED">> {}
}
