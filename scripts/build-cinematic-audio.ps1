...
[1:a]atrim=start=0.47:end=6.7,asetpts=PTS-STARTPTS,highpass=f=22,equalizer=f=48:t=q:w=0.72:g=5.2,equalizer=f=92:t=q:w=0.85:g=3.2,equalizer=f=285:t=q:w=1.0:g=-2.8,equalizer=f=2300:t=q:w=0.8:g=3.4,equalizer=f=6200:t=q:w=0.72:g=2.0,afade=t=out:st=1.10:d=1.60,volume=1.58,adelay=5000|5000[launchImpact];
[4:a]atrim=start=27:end=36.2,asetpts=PTS-STARTPTS,highpass=f=24,lowpass=f=4200,equalizer=f=46:t=q:w=0.75:g=3.2,equalizer=f=88:t=q:w=0.9:g=1.8,equalizer=f=245:t=q:w=1.0:g=-3.4,equalizer=f=1100:t=q:w=0.8:g=0.8,acompressor=threshold=0.14:ratio=2.35:attack=35:release=260:makeup=1.18,afade=t=in:st=0:d=0.16,afade=t=out:st=8.15:d=1.0,volume=0.12,adelay=5850|5850[travelRumble];
...
[7:a]atrim=start=0:end=5.7,asetpts=PTS-STARTPTS,highpass=f=24,lowpass=f=7600,equalizer=f=58:t=q:w=0.8:g=2.0,equalizer=f=180:t=q:w=1.0:g=-2.0,equalizer=f=2200:t=q:w=0.85:g=1.8,afade=t=out:st=1.40:d=1.80,volume=0.62,adelay=5699|5699[growlyHit];
[8:a]atrim=start=0:end=3.1,asetpts=PTS-STARTPTS,highpass=f=20,lowpass=f=340,equalizer=f=43:t=q:w=0.72:g=3.2,equalizer=f=88:t=q:w=0.85:g=1.6,equalizer=f=210:t=q:w=1.0:g=-2.5,afade=t=out:st=0.85:d=1.45,volume=0.46,adelay=5430|5430[metalSub];
[9:a]asplit=3[travelEngineSource][travelEngineSubSource][travelEnginePresenceSource];
[travelEngineSource]atrim=start=0.8:end=10.15,asetpts=PTS-STARTPTS,highpass=f=29,lowpass=f=7600,equalizer=f=62:t=q:w=0.82:g=3.2,equalizer=f=145:t=q:w=0.92:g=4.0,equalizer=f=520:t=q:w=0.9:g=1.6,equalizer=f=2400:t=q:w=0.82:g=1.8,acompressor=threshold=0.18:ratio=1.7:attack=38:release=240:makeup=1.18,afade=t=in:st=0:d=0.28,afade=t=out:st=8.30:d=1.05,volume=3.48,adelay=5880|5880[travelEngine];
[travelEngineSubSource]atrim=start=0.8:end=10.15,asetpts=PTS-STARTPTS,highpass=f=27,lowpass=f=215,equalizer=f=46:t=q:w=0.76:g=4.8,equalizer=f=82:t=q:w=0.86:g=4.2,equalizer=f=150:t=q:w=0.95:g=2.2,acompressor=threshold=0.14:ratio=1.9:attack=42:release=280:makeup=1.22,afade=t=in:st=0:d=0.34,afade=t=out:st=8.20:d=1.15,volume=1.71,adelay=5880|5880[travelEngineSub];
[travelEnginePresenceSource]atrim=start=0.8:end=10.15,asetpts=PTS-STARTPTS,highpass=f=105,lowpass=f=1650,equalizer=f=145:t=q:w=0.88:g=6.0,equalizer=f=320:t=q:w=0.9:g=4.5,equalizer=f=720:t=q:w=0.86:g=3.2,acompressor=threshold=0.12:ratio=1.35:attack=45:release=190:makeup=1.15,afade=t=in:st=0:d=0.25,afade=t=out:st=8.25:d=1.10,volume=3.00,adelay=5880|5880[travelEnginePresence];
...
& ffmpeg -y `
  ...
  -metadata title="Black Vector Hyperspace Theater Mix 12" `
