...
[launchImpactSource]atrim=start=0.47:end=6.7,asetpts=PTS-STARTPTS,highpass=f=22,volume=0.25,equalizer=f=48:t=q:w=0.72:g=7.0,equalizer=f=92:t=q:w=0.85:g=4.6,equalizer=f=285:t=q:w=1.0:g=-3.2,equalizer=f=2300:t=q:w=0.8:g=5.0,equalizer=f=6200:t=q:w=0.72:g=2.8,acompressor=threshold=0.18:ratio=1.55:attack=18:release=210:makeup=1.16,afade=t=out:st=1.10:d=1.60,volume=7.2,adelay=5735|5735[launchImpact];
[launchPunchSource]atrim=start=0.47:end=2.35,asetpts=PTS-STARTPTS,highpass=f=24,lowpass=f=240,volume=0.25,equalizer=f=43:t=q:w=0.7:g=7.8,equalizer=f=78:t=q:w=0.82:g=6.2,equalizer=f=138:t=q:w=0.9:g=3.8,acompressor=threshold=0.11:ratio=2.8:attack=16:release=240:makeup=1.3,afade=t=out:st=0.72:d=0.96,volume=4.1,adelay=5735|5735[launchPunch];
...
[chargeAirSource]atrim=start=6.99:end=8.865,asetpts=PTS-STARTPTS,highpass=f=115,equalizer=f=320:t=q:w=1.0:g=-3.4,equalizer=f=2900:t=q:w=0.82:g=2.8,equalizer=f=7200:t=q:w=0.72:g=3.2,acompressor=threshold=0.22:ratio=1.65:attack=14:release=120:makeup=1.04,afade=t=in:st=0:d=0.16,afade=t=out:st=1.70:d=0.175,volume=0.30,adelay=3900|3900[chargeAir];
[7:a]atrim=start=0:end=5.7,asetpts=PTS-STARTPTS,highpass=f=24,lowpass=f=7600,equalizer=f=58:t=q:w=0.8:g=2.0,equalizer=f=180:t=q:w=1.0:g=-2.0,equalizer=f=2200:t=q:w=0.85:g=1.8,afade=t=out:st=1.40:d=1.80,volume=0.55,adelay=5775|5775[growlyHit];
[8:a]atrim=start=0:end=3.1,asetpts=PTS-STARTPTS,highpass=f=20,lowpass=f=340,equalizer=f=43:t=q:w=0.72:g=3.2,equalizer=f=88:t=q:w=0.85:g=1.6,equalizer=f=210:t=q:w=1.0:g=-2.5,afade=t=out:st=0.85:d=1.45,volume=0.42,adelay=5745|5745[metalSub];
...
[10:a]atrim=start=16.0:end=25.5,asetpts=PTS-STARTPTS,atempo=1.645,highpass=f=28,lowpass=f=11000,equalizer=f=58:t=q:w=0.78:g=3.2,equalizer=f=112:t=q:w=0.9:g=2.4,equalizer=f=330:t=q:w=1.0:g=-1.8,equalizer=f=1750:t=q:w=0.85:g=2.6,equalizer=f=5600:t=q:w=0.8:g=1.8,acompressor=threshold=0.16:ratio=1.65:attack=26:release=185:makeup=1.15,afade=t=in:st=0:d=0.22,afade=t=out:st=5.62:d=0.155,volume=0.62[growlyBuild];
[11:a]asplit=2[electronicBuildSource][exitSuctionSource];
[electronicBuildSource]atrim=start=8.27:end=15.02,asetpts=PTS-STARTPTS,atempo=2.0,highpass=f=72,lowpass=f=12000,equalizer=f=180:t=q:w=0.9:g=-2.4,equalizer=f=920:t=q:w=0.9:g=1.8,equalizer=f=3300:t=q:w=0.8:g=2.6,equalizer=f=7800:t=q:w=0.75:g=2.2,acompressor=threshold=0.2:ratio=1.7:attack=16:release=135:makeup=1.08,afade=t=in:st=0:d=0.2,afade=t=out:st=3.20:d=0.175,volume=0.44,adelay=2400|2400[electronicBuild];
...
[12:a]atrim=start=0:end=3.6,asetpts=PTS-STARTPTS,highpass=f=58,lowpass=f=12500,volume=0.20,equalizer=f=82:t=q:w=0.82:g=3.8,equalizer=f=230:t=q:w=1.0:g=-3.0,equalizer=f=1850:t=q:w=0.82:g=4.8,equalizer=f=4600:t=q:w=0.75:g=3.4,acompressor=threshold=0.13:ratio=2.2:attack=7:release=175:makeup=1.10,afade=t=out:st=1.25:d=1.55,volume=3.25,adelay=5760|5760[newAttack];
...
[14:a]atrim=start=0.10:end=5.8,asetpts=PTS-STARTPTS,highpass=f=20,lowpass=f=540,volume=0.22,equalizer=f=38:t=q:w=0.72:g=6.2,equalizer=f=66:t=q:w=0.84:g=5.0,equalizer=f=145:t=q:w=0.92:g=2.6,equalizer=f=285:t=q:w=1.0:g=-3.8,acompressor=threshold=0.12:ratio=2.4:attack=20:release=285:makeup=1.14,afade=t=out:st=1.65:d=2.55,volume=2.35,adelay=5740|5740[newPressure];
[growlyBuild][electronicBuild][machineryMid][chargeAir][buildA][buildB][launchImpact][launchPunch][growlyHit][metalSub][newAttack][newGrowl][newPressure][travelRumble][travelEngine][travelEngineSub][travelEnginePresence][exitSuction][exitCrystal][exitDrop]amix=inputs=20:normalize=0:dropout_transition=0,highpass=f=20,equalizer=f=55:t=q:w=0.8:g=2.0,equalizer=f=125:t=q:w=0.9:g=1.0,equalizer=f=340:t=q:w=1.0:g=-2.0,equalizer=f=1800:t=q:w=0.8:g=1.0,equalizer=f=4800:t=q:w=0.75:g=1.3,acompressor=threshold=0.26:ratio=1.25:attack=30:release=260:makeup=1.0:knee=3.5,loudnorm=I=-12.5:TP=-1.0:LRA=8,atrim=end=21.3[master]
"@ -replace "`r?`n", ""
...
& ffmpeg -y `
  ...
  -metadata title="Black Vector Hyperspace Theater Mix 17" `
