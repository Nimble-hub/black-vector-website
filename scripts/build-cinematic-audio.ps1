...
[launchImpactSource]atrim=start=0.47:end=6.7,asetpts=PTS-STARTPTS,highpass=f=22,volume=0.25,equalizer=f=48:t=q:w=0.72:g=7.0,equalizer=f=92:t=q:w=0.85:g=4.6,equalizer=f=285:t=q:w=1.0:g=-3.2,equalizer=f=2300:t=q:w=0.8:g=5.0,equalizer=f=6200:t=q:w=0.72:g=2.8,acompressor=threshold=0.18:ratio=1.55:attack=18:release=210:makeup=1.16,afade=t=out:st=1.10:d=1.60,volume=8.2,adelay=5120|5120[launchImpact];
[launchPunchSource]atrim=start=0.47:end=2.35,asetpts=PTS-STARTPTS,highpass=f=24,lowpass=f=240,volume=0.25,equalizer=f=43:t=q:w=0.7:g=7.8,equalizer=f=78:t=q:w=0.82:g=6.2,equalizer=f=138:t=q:w=0.9:g=3.8,acompressor=threshold=0.11:ratio=2.8:attack=16:release=240:makeup=1.3,afade=t=out:st=0.72:d=0.96,volume=4.72,adelay=5120|5120[launchPunch];
...
[7:a]atrim=start=0:end=5.7,asetpts=PTS-STARTPTS,highpass=f=24,lowpass=f=7600,equalizer=f=58:t=q:w=0.8:g=2.0,equalizer=f=180:t=q:w=1.0:g=-2.0,equalizer=f=2200:t=q:w=0.85:g=1.8,afade=t=out:st=1.40:d=1.80,volume=0.62,adelay=5819|5819[growlyHit];
[8:a]atrim=start=0:end=3.1,asetpts=PTS-STARTPTS,highpass=f=20,lowpass=f=340,equalizer=f=43:t=q:w=0.72:g=3.2,equalizer=f=88:t=q:w=0.85:g=1.6,equalizer=f=210:t=q:w=1.0:g=-2.5,afade=t=out:st=0.85:d=1.45,volume=0.46,adelay=5550|5550[metalSub];
...
& ffmpeg -y `
  ...
  -metadata title="Black Vector Hyperspace Theater Mix 16" `
