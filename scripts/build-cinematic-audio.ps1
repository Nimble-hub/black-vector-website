...
foreach ($source in @($drop, $impact, $riser, $stinger, $rumble)) {
...
[buildA][buildB][launchImpact][travelRumble][exitDrop]amix=inputs=5:normalize=0:dropout_transition=0,highpass=f=20,equalizer=f=55:t=q:w=0.8:g=2.2,equalizer=f=125:t=q:w=0.9:g=1.2,equalizer=f=340:t=q:w=1.0:g=-1.8,equalizer=f=1800:t=q:w=0.8:g=1.0,equalizer=f=4800:t=q:w=0.75:g=1.4,acompressor=threshold=0.2:ratio=1.7:attack=24:release=190:makeup=1.08:knee=2.5,loudnorm=I=-12.5:TP=-1.0:LRA=8,atrim=end=20[master]
"@ -replace "`r?`n", ""
...
& ffmpeg -y `
  ...
  -metadata title="Black Vector Hyperspace Theater Mix" `
