...
[1:a]atrim=start=0.47:end=6.7,asetpts=PTS-STARTPTS,highpass=f=22,equalizer=f=48:t=q:w=0.72:g=5.2,equalizer=f=92:t=q:w=0.85:g=3.2,equalizer=f=285:t=q:w=1.0:g=-2.8,equalizer=f=2300:t=q:w=0.8:g=3.4,equalizer=f=6200:t=q:w=0.72:g=2.0,afade=t=out:st=1.10:d=1.60,volume=1.58,adelay=5120|5120[launchImpact];
...
& ffmpeg -y `
  ...
  -metadata title="Black Vector Hyperspace Theater Mix 15" `
